...
Unlike clients such as GETH, the dogechain doesn't use reflection for the encoding.<br />
...
By manually defining these methods, the dogechain doesn't need to use reflection. In *rlp_marshal.go*, you can find
