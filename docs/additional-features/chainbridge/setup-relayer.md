  ...
  "chains": [
    {
      ...
      "type": "ethereum",
      "id": "568",
      "endpoint": "https://rpc-teddy.dogecoin.community",
...
INFO[11-19|07:15:25] Connecting to ethereum chain...          chain=teddy url=<JSON_RPC_URL>
Enter password for key ./keys/<RELAYER_ACCOUNT_ADDRESS>.key:
> [PASSWORD_TO_DECRYPT_KEY]
INFO[11-19|07:15:31] Connecting to ethereum chain...          chain=doge-evm url=<JSON_RPC_URL>
```
