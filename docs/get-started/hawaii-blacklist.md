---
id: hawaii-blacklist
title: Hawaii Blacklist
---

After Hawaii Hard Fork, we still get some historical legacy whose state tree is too big to handled.

Recently, we still need to blacklist these contracts to avoid bringing down the entire network, but new contracts should not be affected.

The blacklisted accounts and contracts are as below:
...
[
    ...
    "0x2AD2af3227105e739226375323A824A010f4A577",
