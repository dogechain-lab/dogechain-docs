...
One of the main modules of the dogechain are **Blockchain** and **State**. <br />
...
The Blockchain Events are the original events that happen in dogechain, and they're later mapped to a Protocol Buffers message format for easy transfer.
:::